                            ...
                            <div class="card">                        	     
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5 col-xs-12 mb-3">
                                        <p class="form-control-plaintext text-left"><i class="fa fa-briefcase"></i> Price (max. &#8358;100,000.00)</p><br>
                                        <input type="number" class="form-control" name="amount" id="amount" value="" placeholder="Enter amount" max="100000" required><br><br>
                                        <p class="form-control-plaintext text-left"><i class="fa fa-picture-o"></i> Image URIs</p><br>
