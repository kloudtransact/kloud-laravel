...
<div class="container-fluid">
                <div class="row">
                    <div class="col-12 col-lg-12">
                        <div class="checkout_details_area mt-50 wow fadeInUp clearfix">
                        	   <div class="card text-white">
                        	     ...
                        	     <div class="card-img-overlayy ml-5">
                        	       <h2 class="card-title wow fadeInUp" style="color: #fbb710 !important; padding: 5px;">Become a Merchant</h2>
                        	       <h4 class="card-text wow fadeInUp" style="padding: 5px;">Creating your own store is super easy! Just fill in the details below and we are good to go.</h4>
								...
								?>
									...
									<div class="col-md-12 mb-3 wow fadeInUp">
									...
									<div class="col-md-6 mb-3 wow fadeInUp">
                                        <input type="password" class="form-control" name="pass_confirmation" value="" placeholder="Password" required>
                                    </div>
									@endif									
